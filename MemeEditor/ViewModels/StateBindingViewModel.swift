...
open class StateBindingViewModel<State: Equatable>: ObservableObject {
    ...
    public func update<Value>(_ keyPath: WritableKeyPath<State, Value>, to newValue: Value) where Value: Equatable {
    ...
    open func stateWillChangeValue<Value>(_ keyPath: PartialKeyPath<State>, newValue: Value) -> Bool where Value: Equatable {
        return true
    }
